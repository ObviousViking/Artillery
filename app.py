...
# ---------------------------------------------------------------------
# Remove media wall constants and DB
...
# Remove touch_mediawall_notify function

# Remove DB helpers: get_db_conn, _kv_get, _kv_set, get_media_wall_interval, set_media_wall_interval

# Remove media wall endpoints: mediawall_toggle, mediawall_interval, wall_file, mediawall_list_cache, mediawall_events

# In home(): remove media wall logic, just return render_template with tasks_count

# In run_task_background: remove touch_mediawall_notify call

# Remove sqlite3 import if not needed elsewhere
